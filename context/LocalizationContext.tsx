...
const translationTable: Record<Language, Translations> = {
  ar: {
    ...
    'home.hero.badge': 'نحن هنا معك لنساندك',
    ...
    'assessments.subtitle': 'اكتشف نفسك أكثر من خلال اختباراتنا العلمية',
    'assessments.backToList': 'عودة للقائمة',
    'assessments.resultTitle': 'النتيجة',
    'assessments.done': 'إنهاء',
    'assessments.questionOf': 'سؤال {current} من {total}',
    'assessments.questionsCount': '{count} أسئلة',
    'assessments.startNow': 'ابدأ الآن',
    'assessments.badge.validated': 'معتمد عالمياً',
    'assessments.badge.safety': 'السلامة أولاً',
    'assessments.gender.male': 'ذكر',
    'assessments.gender.female': 'أنثى',
    'assessments.finish.title': 'تم الانتهاء من الاختبار',
    'assessments.finish.subtitle': 'اختر عرض النتيجة الأولية أو تحليلها مع هادي',
    'assessments.finish.preliminary': 'عرض النتيجة الأولية',
    'assessments.finish.analyze': 'تحليل مع هادي',
    'assessments.finish.analyzing': 'جارٍ الإرسال...',
    ...
    'profile.settings.fullName': 'الاسم الكامل',
    'profile.settings.phone': 'رقم الهاتف',
    'profile.settings.dateOfBirth': 'تاريخ الميلاد',
    'profile.settings.gender': 'الجنس',
    'profile.settings.genderMale': 'ذكر',
    'profile.settings.genderFemale': 'أنثى',
    'profile.settings.genderOther': 'آخر',
    'profile.settings.oldPassword': 'كلمة المرور الحالية',
    'profile.settings.newPassword': 'كلمة المرور الجديدة',
    'profile.settings.confirmPassword': 'تأكيد كلمة المرور الجديدة',
    'profile.settings.successProfileUpdate': 'تم تحديث الملف الشخصي بنجاح',
    'profile.settings.successPasswordUpdate': 'تم تغيير كلمة المرور بنجاح',
    'profile.settings.passwordMismatch': 'كلمتا المرور غير متطابقتين',
    'profile.settings.deleteConfirmTitle': 'حذف الحساب نهائياً',
    'profile.settings.deleteConfirmDesc': 'هل أنت متأكد من رغبتك في حذف الحساب؟ سيؤدي هذا الإجراء إلى حذف جميع بياناتك نهائياً ولا يمكن التراجع عنه.',
    'profile.settings.deleteConfirmButton': 'نعم، احذف حسابي',
    ...
    'profile.about.desc': 'هادي هو منصة وطنية مدعومة بالذكاء الاصطناعي مصممة خصيصًا للمملكة العربية السعودية، توفر دعمًا نفسيًا آمنًا ومباشرًا باستخدام استدلال تشخيصي منظم يتوافق مع معايير DSM-5 ومنهجية ICCR الملكية.\n\nيكتشف التطبيق العلامات المبكرة للاكتئاب والقلق والاستعداد النفسي والفكر الانتحاري من خلال تحليل متعدد الوسائط للنصوص والصوت وأنماط السلوك. يولد تقارير تحليلية عالية الجودة للمعالجين ويتيح الإشراف الأبوي لمراقبة صحة الأبناء النفسية.\n\nالميزات الرئيسية: وصول على مدار الساعة لمحادثة علاجية متعاطفة، نظام إنذار مبكر للمؤشرات عالية الخطورة، لوحة تحكم للمعالجين مع تتبع PHQ-9 وGAD-7، إدارة خطط العلاج وسجلات الجلسات، والامتثال الكامل لقواعد حماية البيانات السعودية PDPL مع تخزين بيانات محلي.\n\n⚠️ هذا التطبيق لا يُغني عن استشارة الطبيب أو المعالج النفسي.',
    ...
    'consent.title': 'موافقة على استخدام الذكاء الاصطناعي',
    'consent.whatData': 'ما هي البيانات التي يتم إرسالها؟',
    'consent.whatDataDesc': 'رسائلك في المحادثة، ونتائج الاختبارات النفسية التي تقوم بها',
    'consent.toWhom': 'إلى من يتم إرسال البيانات؟',
    'consent.toWhomDesc': 'يتم إرسالها إلى خوادمن الآمنة وخدمة الذكاء الاصطناعي التي نستخدمها لتزويدك بالردود',
    'consent.why': 'لماذا نحتاج هذه البيانات؟',
    'consent.whyDesc': 'لتزويدك بمحادثات شخصية وتحاليل دقيقة لحالتك النفسية',
    'consent.accept': 'أوافق',
    'consent.decline': 'لا أوافق',
    'consent.disclaimer': 'هذا التطبيق لا يُغني عن استشارة الطبيب أو المعالج النفسي',
  },
  en: {
    ...
    'home.hero.badge': 'We are here to support you',
    ...
    'assessments.subtitle': 'Discover yourself through our evidence-based tests',
    'assessments.backToList': 'Back to list',
    'assessments.resultTitle': 'Result',
    'assessments.done': 'Done',
    'assessments.questionOf': 'Question {current} of {total}',
    'assessments.questionsCount': '{count} questions',
    'assessments.startNow': 'Start now',
    'assessments.badge.validated': 'Validated',
    'assessments.badge.safety': 'Safety first',
    'assessments.gender.male': 'Male',
    'assessments.gender.female': 'Female',
    'assessments.finish.title': 'Assessment completed',
    'assessments.finish.subtitle': 'View your preliminary result or analyze it with Hadee',
    'assessments.finish.preliminary': 'View preliminary result',
    'assessments.finish.analyze': 'Analyze with Hadee',
    'assessments.finish.analyzing': 'Sending...',
    ...
    'profile.settings.dateOfBirth': 'Date of Birth',
    'profile.settings.gender': 'Gender',
    'profile.settings.genderMale': 'Male',
    'profile.settings.genderFemale': 'Female',
    'profile.settings.genderOther': 'Other',
    'profile.settings.oldPassword': 'Current Password',
    'profile.settings.newPassword': 'New Password',
    'profile.settings.confirmPassword': 'Confirm New Password',
    'profile.settings.successProfileUpdate': 'Profile updated successfully',
    'profile.settings.successPasswordUpdate': 'Password changed successfully',
    'profile.settings.passwordMismatch': 'Passwords do not match',
    'profile.settings.deleteConfirmTitle': 'Delete Account Permanently',
    'profile.settings.deleteConfirmDesc': 'Are you sure you want to delete your account? This action will permanently delete all your data and cannot be undone.',
    'profile.settings.deleteConfirmButton': 'Yes, delete my account',
    ...
    'profile.about.desc': 'Hadi is a national AI-powered mental health platform designed specifically for Saudi Arabia, providing safe, first-line psychological support using structured diagnostic reasoning aligned with DSM-5 criteria and the proprietary ICCR methodology.\n\nThe app detects early signs of depression, anxiety, burnout, and suicidal ideation through multi-modal analysis of text, voice, and behavioral patterns. It generates clinical-grade analytical reports for therapists and enables parental supervision for youth mental health monitoring.\n\nKey features: 24/7 access to empathetic therapeutic dialogue, an early warning system for high-risk indicators, a therapist dashboard with PHQ-9 and GAD-7 tracking, treatment plan management, session logs, and full compliance with Saudi PDPL data regulations with local data storage.\n\n⚠️ This app does not replace consulting a doctor or mental health professional.',
    ...
    'consent.title': 'AI Usage Consent',
    'consent.whatData': 'What data is sent?',
    'consent.whatDataDesc': 'Your chat messages and psychological test results',
    'consent.toWhom': 'Who receives the data?',
    'consent.toWhomDesc': 'It is sent to our secure servers and the AI service we use to provide you with responses',
    'consent.why': 'Why do we need this data?',
    'consent.whyDesc': 'To provide you with personalized conversations and accurate analysis of your mental health',
    'consent.accept': 'I Agree',
    'consent.decline': 'I Decline',
    'consent.disclaimer': 'This app does not replace consulting a doctor or mental health professional',
  },
};
